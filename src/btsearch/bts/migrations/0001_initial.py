...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('bts', ['Location'])

        # Adding model 'BaseStation'
        db.create_table('bts_basestation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('bts', ['BaseStation'])

        # Adding model 'Cell'
        db.create_table('bts_cell', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('bts', ['Cell'])

        # Adding model 'Network'
        db.create_table('bts_network', (
        ...
        db.send_create_signal('bts', ['Network'])

        # Adding model 'Region'
        db.create_table('bts_region', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('country_code', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('bts', ['Region'])


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table('bts_location')

        # Deleting model 'BaseStation'
        db.delete_table('bts_basestation')

        # Deleting model 'Cell'
        db.delete_table('bts_cell')

        # Deleting model 'Network'
        db.delete_table('bts_network')

        # Deleting model 'Region'
        db.delete_table('bts_region')
