...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('bts_basestationpermission', ['base_station_id', 'permission_id', 'station_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BaseStationPermission', fields ['base_station', 'permission', 'station_id']
        db.delete_unique('bts_basestationpermission', ['base_station_id', 'permission_id', 'station_id'])
    ...
    models = {
        'bts.basestation': {
            ...
            'permissions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'base_stations'", 'symmetrical': 'False', 'through': "orm['bts.BaseStationPermission']", 'to': "orm['uke.Permission']"}),
        ...
        'bts.basestationpermission': {
            ...
            'base_station': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bts.BaseStation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['uke.Permission']"}),
