...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('uke', ['Location'])

        # Adding model 'Permission'
        db.create_table('uke_permission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('uke', ['Permission'])

        # Adding model 'Operator'
        db.create_table('uke_operator', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('uke', ['Operator'])

        # Adding model 'RawRecord'
        db.create_table('uke_rawrecord', (
        ...
        db.send_create_signal('uke', ['RawRecord'])


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table('uke_location')

        # Deleting model 'Permission'
        db.delete_table('uke_permission')

        # Deleting model 'Operator'
        db.delete_table('uke_operator')

        # Deleting model 'RawRecord'
        db.delete_table('uke_rawrecord')
